...
class __TwigTemplate_dc01bb0d3d11c24a0af34bc79a7bc614e82b0b1c5d8c8c2909ee4853ed2a148d extends Template
{
    private $source;
    private $macros = [];
...
{% block main %}
    <form method=\"POST\" action=\"#\" class=\"form-signin\">
        ...
        <button class=\"btn btn-lg btn-primary btn-block\" type=\"submit\">Sign in</button>
        <p class=\"mt-5 mb-3 text-muted\">&copy; 2017-2018 <a href=\"{{ path('front') }}\">main page</a></p>
    </form>
{% endblock %}
{% block footer_links %}{% endblock %}", "front/login.html.twig", "/var/www/html/templates/front/login.html.twig");
    }
}
