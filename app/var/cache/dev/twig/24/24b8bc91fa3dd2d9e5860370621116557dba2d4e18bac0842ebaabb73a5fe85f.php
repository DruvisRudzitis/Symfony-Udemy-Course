...
class __TwigTemplate_c6915f042d34c37a26d6c8e1c77313f74bfc83d270ee7052bbe5059fb60726ce extends Template
{
    private $source;
    private $macros = [];
...
<main role=\"main\">
    ...
    <div class=\"album py-5 bg-light\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["sample_videos"]) || array_key_exists("sample_videos", $context) ? $context["sample_videos"] : (function () { throw new RuntimeError('Variable "sample_videos" does not exist.', 51, $this->source); })()));
...
";
    ...
    {
        return array (  191 => 105,  171 => 87,  157 => 79,  130 => 55,  125 => 52,  121 => 51,  73 => 5,  71 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
                        ...
                        <div class=\"card-body\">
                            ...
                            <div class=\"d-flex justify-content-between align-items-center\">
                                <div class=\"btn-group\">
                                    ...
                                    <a href=\"{{ path('video_details') }}\">Comments (32)</a>
                                </div>
                                <small class=\"text-muted\">9 mins</small>
                            </div>
                        </div>
...
{% endblock %}", "front/video_list.html.twig", "/var/www/html/templates/front/video_list.html.twig");
    }
}
